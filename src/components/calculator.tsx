...
export default function Calculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-fuchsia-700 dark:bg-fuchsia-900">
      {/* Center the calculator within the screen */}
      <Card className="w-full max-w-md p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        {/* Card header with title */}
        <CardHeader>
          <CardTitle className="text-2xl font-bold">
          <u><center> Simple Calculator</center></u>
          </CardTitle>
        </CardHeader>
  ...
  <h1 className="text-2xl font-bold text-gray-800">Developed By:</h1>
  <h1 className="text-2xl font-bold text-gray-800">Hareem Jaweid</h1>
</div>
